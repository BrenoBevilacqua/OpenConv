    ...
    <form method="POST" action="{{ route('convenio.update', $convenio->id) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <textarea name="natureza_despesa" id="natureza_textarea" 
class="w-full border border-gray-300 rounded px-3 py-2 mt-2">{{ old('natureza_despesa', $convenio->natureza_despesa) }}</textarea>
                <!--<label class="block font-bold text-gray-700 mb-1">Natureza de Despesa</label>
